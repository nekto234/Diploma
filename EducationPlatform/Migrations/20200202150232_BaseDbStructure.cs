        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityStamp = table.Column<string>(nullable: false, defaultValue: Guid.NewGuid().ToString()),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_Course_Teacher_AspNetUsers",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAccess = table.Column<bool>(nullable: true, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student", x => x.StudentId);
                    table.ForeignKey(
                        name: "fk_Student_AspNetUsers",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(maxLength: 256, nullable: true),
                    HasTest = table.Column<bool>(nullable: true),
                    HasLab = table.Column<bool>(nullable: true),
                    MinTestMark = table.Column<int>(nullable: true),
                    MaxTestMark = table.Column<int>(nullable: true),
                    MinLabMark = table.Column<int>(nullable: true),
                    MaxLabMark = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_CourseModule_Course",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_CourseModule_Module",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MarkId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TestMark = table.Column<int>(nullable: true),
                    LabMark = table.Column<int>(nullable: true),
                    StudentId = table.Column<int>(nullable: false),
                    CourseModuleId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Student__1788CC4D8BA74B7F",
                table: "Student",
                column: "UserId",
                unique: true);
        }
